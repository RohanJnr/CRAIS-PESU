    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_part_2', models.CharField(max_length=64)),
                ('landing_page_paragraph', models.CharField(max_length=312)),
                ('highlight_text', models.CharField(blank=True, max_length=128, null=True)),
                ('highlight_link', models.URLField(blank=True, null=True)),
                ('highlight_image', models.ForeignKey(blank=True, help_text='Hightlight image', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image')),
            ],
            options={
                'abstract': False,
            },
