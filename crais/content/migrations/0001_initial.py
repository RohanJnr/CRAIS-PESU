    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('about', wagtail.fields.RichTextField(help_text='About the member.')),
                ...
                ('designation', models.CharField(blank=True, help_text="Ignore this field if 'category' is sufficient.", max_length=255, null=True)),
                ('pes_faculty_profile_link', models.URLField(blank=True, help_text='If applicable', null=True)),
                ('srn', models.CharField(blank=True, help_text='If applicable', max_length=32, null=True)),
                ('university', models.CharField(default='PES University', max_length=128)),
                ('member_page', models.BooleanField(default=True, help_text='Generates a page at /team/<name> with details for the member.')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='content.member')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='member',
            name='faculty_guide',
            field=models.ForeignKey(blank=True, help_text='If applicable', null=True, on_delete=django.db.models.deletion.SET_NULL, to='content.member'),
        ),
        migrations.AddField(
            model_name='member',
            name='image',
            field=models.ForeignKey(blank=True, help_text='Square images are preferred, if not, then please try to upload images with width > height, i.e, landscape images are better.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='course',
            name='program',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='content.courseprogram'),
        ),
        migrations.CreateModel(
            name='CenterInventor',
            fields=[
